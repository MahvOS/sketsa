            ...
            <div className="sidebar-content">
              <div className="sidebar-group">
                ...
                <div className="compact-mode-toggle">
                  <button onClick={() => setMode('juz')} className={mode === 'juz' ? 'active' : ''}>Juz</button>
                  <button onClick={() => setMode('surah')} className={mode === 'surah' ? 'active' : ''}>Surat</button>
                </div>
              </div>
              ...
              <button onClick={generateSoal} className="compact-generate-btn hide-mobile">
                <Sparkles size={16} />
                Generate Soal
              </button>
            </div>
            ...
            {currentVerse ? (
              ...
              >
                <div className="compact-meta">
                  ...
                  <span className="meta-arabic hide-mobile">{currentVerse.surahName}</span>
                </div>
              ...
              <div className="compact-empty">
                <BookOpen size={48} strokeWidth={1} className="text-slate-200 mb-4 mx-auto" />
